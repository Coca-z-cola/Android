package cn.edu.neusoft.zwt.notebook.view;
...
import cn.edu.neusoft.zwt.notebook.activity.ClockReceiver;
import cn.edu.neusoft.zwt.notebook.activity.NoteEditActivity;
import cn.edu.neusoft.zwt.notebook.model.ClockModel;
import cn.edu.neusoft.zwt.notebook.model.NoteItemModel;
import cn.edu.neusoft.zwt.notebook.tools.DBHelper;
import cn.edu.neusoft.zwt.notebook.view.clock.ClockView;
...
public class NoteEditView extends LinearLayout implements OnClickListener {
	...
	protected void addAudio() {
		...
		final cn.edu.neusoft.zwt.notebook.view.NoteEditAudioView audioView = new cn.edu.neusoft.zwt.notebook.view.NoteEditAudioView(
				this.getContext());
