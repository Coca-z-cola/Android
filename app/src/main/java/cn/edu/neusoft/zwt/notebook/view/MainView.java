...
public class MainView extends LinearLayout {
	...
	private cn.edu.neusoft.zwt.notebook.view.NotesListView mListView;
	...
	private void initResource() {
		this.mListView = (cn.edu.neusoft.zwt.notebook.view.NotesListView) this.findViewById(R.id.notes_list);
		...
		this.mNewButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				((Activity) MainView.this.getContext()).startActivityForResult(
						intent, 1);
				MainView.this.mListView.setStatus(cn.edu.neusoft.zwt.notebook.view.NotesListView.STATUS_CREATE);
			}
